...
# # CSV file with custom columns + extra fields saved to DB
# ingest_dataset(
#     "data/posts.csv",
#     source="CSV Export",
#     source_type="file",
...
#     col_url="link",
#     extra_cols={
#         "author":    "username",       # db col "author"    <- csv col "username"
#         "title":     "post_title",     # db col "title"     <- csv col "post_title"
#         "published": "date_published", # db col "published" <- csv col "date_published"
#     }
# )
...
#     source="News Scrape",
#     source_type="file",
#     col_text=["content", "body", "text"],  # tries each in order
#     col_url="article_url",
# )
